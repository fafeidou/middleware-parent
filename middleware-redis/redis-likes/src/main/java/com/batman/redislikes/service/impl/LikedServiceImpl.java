package com.batman.redislikes.service.impl;

import com.batman.redislikes.entity.LikedStatusEnum;
...
import com.batman.redislikes.repository.UserLikeRepository;
import com.batman.redislikes.repository.UserRepository;
import com.batman.redislikes.service.LikedService;
...
public class LikedServiceImpl implements LikedService {
    ...
    public void transLikedCountFromRedis2DB() {
        ...
        for (LikedCountDTO dto : list) {
            UserInfo user = userRepository.findById(dto.getId()).get();
